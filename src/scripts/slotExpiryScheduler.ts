...
const systemLog = new SystemLogService();
...
export async function expirePastVisitSlots(): Promise<{ updated: number }> {
...
export function startSlotExpiryScheduler(): void {
  // Run once on startup
